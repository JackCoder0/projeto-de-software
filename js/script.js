...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (logo) {
    logo.addEventListener('click', function () {
      clickCount++;
      if (clickCount === 5) {
        showAlert('🎉 Você descobriu um easter egg! A TechGlass Solutions agradece sua curiosidade!', 'success');
        clickCount = 0;
      }
    });
  }
  ...
  console.log('🚀 TechGlass Solutions website carregado com sucesso!');
});
